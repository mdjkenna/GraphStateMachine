 ...
 * Use this to store transition action results that constrain which edges can be traversed at any given time.
 *
 * e.g. If storing that a network call was not successful, and this should impact transition behaviour, store that result in an implementer of this interface inside the transition guard.
 * This will then share the result across all edges' transition guard functions.
 *
