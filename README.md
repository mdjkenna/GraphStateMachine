...
<details>
<summary>Some Considerations when designing a GraphStateMachine</summary>

**Edge Traversal Order**: Edges have a fixed traversal order to ensure predictable and consistent state transitions. 
...
**Edge Traversal Progression**: Edges have a traversal order for deterministic traversal. The state machine keeps track of the next outgoing edge to traverse. 
